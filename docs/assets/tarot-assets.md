...
- 传统 RWS 牌面保留为兼容基线；第二轮正式界面使用用户确认的两套图鉴，经离线裁切、逐张稳定 ID 映射和完整性校验后进入运行时。

## 第二轮双主题

所有源图均为用户在本次项目会话中明确提供并要求优先使用的 1055×1491 PNG。运行时不加载整张图鉴，只加载 `prepare_theme_assets.py` 生成的 400×600 JPEG。

| 主题 | 内容 | 附件 | SHA-256 |
|---|---|---:|---|
| 月影花庭 | 大阿尔卡那 | 19 | `DF3C256D3722A104FA7B22831E0C5EB4E26CFCE8A79D8F58FBF91A7A7AB49577` |
| 月影花庭 | 权杖 / 圣杯 | 18（与 24 重复） | `D6EA4A6D3F6981F1845CCC8D7B40E6E41A74AFC0078CCA23050C32D102FEE445` |
| 月影花庭 | 宝剑 / 星币 | 20 | `006A6DF7A541F7288D3AB9B3B8C68C77BE25AB8CFCF73EF89FEB88FDA2FD67CB` |
| 星璃穹顶 | 大阿尔卡那 | 21 | `4E70C91B74B5000455C56BF953A4D6EB4A9032EF41FBDBA64C42C444B6931FB9` |
| 星璃穹顶 | 权杖 / 圣杯 | 22（与 25 重复） | `7C04FC815842626F033868ABCB086F8F712A9DD06B58867B573750E25176FEE9` |
| 星璃穹顶 | 宝剑 / 星币 | 23 | `459465C4661B1D434E2B0FCC6A3DE0FD8A996FB817AEE04EEFD951FE4B509064` |

生成流程保留完整牌框并等比置入 2:3 画布；牌背从图鉴预览中的前景单牌做四点透视校正。`validate-theme-assets.ps1` 要求每套 78 张正面、一个牌背、固定尺寸且全部可读，失败主题不得暴露给设置页。
